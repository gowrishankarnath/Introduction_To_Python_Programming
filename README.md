...
### Book Source Code  
You need to download the folder [Code](/Book_Code) and open it in PyCharm IDE. Each of the code files are numbered and they appear under a Chapter number. The numbering of the code files corresponds to the order in which they appear in the book. Each of the code file is a self-contained file. To run a code file, right-click on the file name in the PyCharm IDE and select the "Run" from the context menu.
